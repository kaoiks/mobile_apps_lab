...
class DessertAdapter(private val context: Context, private val recipes: ArrayList<Recipe>) :
    RecyclerView.Adapter<DessertAdapter.ViewHolder>() {

    val recipeArrayList: ArrayList<Recipe>
    private var itemClickListener: DessertListFragment.OnItemClickListener? = null
    ...
    fun setOnItemClickListener(listener: DessertListFragment.OnItemClickListener) {
